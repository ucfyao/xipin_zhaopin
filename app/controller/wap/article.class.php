...
class article_controller extends common{
	...
	function show_action(){
        ...
        $NewBaseInfo['content']=$NewContentInfo['content'];
        
		if($NewBaseInfo["keyword"]!=""){
			
			$keyarr = @explode(",",$NewBaseInfo["keyword"]);
		...
		$data['news_title']=$NewBaseInfo['title'];
		$data['news_keyword']=$NewBaseInfo['keyword'];
		$description=$NewBaseInfo['description']?$NewBaseInfo['description']:$NewBaseInfo['content'];
