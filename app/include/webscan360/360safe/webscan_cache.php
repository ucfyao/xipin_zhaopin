...
include(dirname(dirname(dirname(dirname(dirname(__FILE__)))))."/data/plus/admindir.php");
//拦截开关(1为开启，0关闭)
$webscan_switch=1;
...
$webscan_white_directory=$admindir.'|\/dede\/|\/install\/';
...
$webscan_white_url = array('index.php' => 'admin_dir='.$admindir.'','post.php' => 'job=postnew&step=post','edit_space_info.php'=>'');
?>